...
final class Hq008AdReporter {
    ...
    interface DeviceInfoProvider { DeviceInfo collect(); }
    private final DeviceInfoProvider deviceInfoProvider;
    private final String sdkEntry;
    ...
    Hq008AdReporter(
        ...
        this(() -> DeviceInfo.collect(context), okHttpClient, gson, channelId, apiBaseUrl, "ima");
    }

    Hq008AdReporter(DeviceInfoProvider provider, OkHttpClient okHttpClient, Gson gson,
                    String channelId, String apiBaseUrl, String sdkEntry) {
    ...
    Hq008AdReporter() {
        this.deviceInfoProvider = DeviceInfo::empty;
        this.sdkEntry = "ima";
    ...
    void requested(String requestId, long createdAtMs, int width, int height, Map<String, Object> timing) {
        ...
        diagnostics.put("sdk", "ad-sdk-fusion");
    ...
    private Map<String, Object> baseDiagnostics(long createdAtMs, Map<String, Object> timing) {
        ...
        diagnostics.put("sdkEntry", sdkEntry);
        diagnostics.put("channelId", channelId);
