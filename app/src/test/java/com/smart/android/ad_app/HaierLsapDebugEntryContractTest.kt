...
class HaierLsapDebugEntryContractTest {
    ...
    fun `haier_lsap flavor should declare dedicated sdk dependency and identifiers`() {
        ...
        assertTrue(buildGradle.contains("haier_lsapImplementation files('libs/haier_lsap/lsapsdk-com.google.android.adhaierlsap-1.1.12.aar')"))
        ...
        assertTrue(flavorBlock.contains("versionCode         : 3"))
        assertTrue(flavorBlock.contains("versionName         : \"1.0.3\""))
